...
describe 'rsyslog' do
  ...
  describe 'Test standard installation' do
    ...
    it { should contain_service('rsyslog').with_enable('true') }
    it { should contain_file('rsyslog.conf').with_ensure('present') }
  end

  describe 'Test installation of a specific version' do
    let(:params) { {:version => '1.0.42' } }
    it { should contain_package('rsyslog').with_ensure('1.0.42') }
  end
  ...
  describe 'Test decommissioning - absent' do
    ...
    it 'should not enable at boot Service[rsyslog]' do should contain_service('rsyslog').with_enable('false') end
    it 'should remove rsyslog configuration file' do should contain_file('rsyslog.conf').with_ensure('absent') end
  ...
  describe 'Test decommissioning - disableboot' do
    ...
    it { should_not contain_service('rsyslog').with_ensure('absent') }
    it 'should not enable at boot Service[rsyslog]' do should contain_service('rsyslog').with_enable('false') end
    it { should contain_file('rsyslog.conf').with_ensure('present') }
  ...
  describe 'Test customizations - template' do
    let(:params) { {:template => "rsyslog/spec.erb" , :options => { 'opt_a' => 'value_a' } } }
  ...
  describe 'Test customizations - source' do
    ...
    it 'should request a valid source ' do
      content = catalogue.resource('file', 'rsyslog.conf').send(:parameters)[:source]
      content.should == "puppet://modules/rsyslog/spec"
    end
    it 'should request a valid source dir' do
      content = catalogue.resource('file', 'rsyslog.dir').send(:parameters)[:source]
      content.should == "puppet://modules/rsyslog/dir/spec"
    end
    it 'should purge source dir if source_dir_purge is true' do
      content = catalogue.resource('file', 'rsyslog.dir').send(:parameters)[:purge]
      content.should == true
    end
  end

  describe 'Test customizations - custom class' do
    let(:params) { {:my_class => "rsyslog::spec" } }
  ...
  describe 'Test Puppi Integration' do
    ...
    it 'should generate a puppi::ze define' do
      content = catalogue.resource('puppi::ze', 'rsyslog').send(:parameters)[:helper]
  ...
  describe 'Test OldGen Module Set Integration' do
    ...
    it 'should generate puppi resources ' do 
      content = catalogue.resource('puppi::ze', 'rsyslog').send(:parameters)[:ensure]
  ...
  describe 'Test params lookup' do
    let(:facts) { { :rsyslog_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
  ...
  describe 'Test params lookup' do
    let(:facts) { { :monitor => false , :rsyslog_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
